...
class TVShowProxyModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.season_2 = TVShowSeasonProxy.objects.create(title='The Office Series Season 2', parent=the_office, order=2)
        self.season_3 = TVShowSeasonProxy.objects.create(title='The Office Series Season 3', parent=the_office, order=3)
        self.season_4 = TVShowSeasonProxy.objects.create(title='The Office Series Season 4', parent=the_office, order=4)
        ...
        # Create TV shows with videos
        self.obj_a = TVShowProxy.objects.create(title='This is my title', video=self.video_a)
        self.obj_b = TVShowProxy.objects.create(title='This is my title', state=PublishStateOptions.PUBLISH, video=self.video_a)
    ...
    def test_playlist_video_through_model(self):
        ...
        self.assertEqual(video_qs, playlist_item_qs)
    ...
    def test_publish_manager(self):
        ...
        self.assertTrue(published_qs.exists())
        self.assertEqual(published_qs.count(), TVShowProxy.objects.all().published().count())
